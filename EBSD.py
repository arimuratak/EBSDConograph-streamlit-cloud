...
ArrayDeriv2 = None
name_pickle = 'result/out.pickle'
name_ArrayDeriv2 = 'result/out.2nd_derivative.tif'
...
def set_params (path = './params.py'):
    ...
    for k, vs in pdict.items():
        ...
        if k == 'Circle': params.Circle = {'False':False, 'True' : True}[vs]
...
def addBand_theta_rho(theta, rho):
    ...
    if find(theta, rho, BandKukans) is not None:
        ...
        return 'Failed: band already exists'
    # バンドを取得して追加する
